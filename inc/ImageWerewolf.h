...
extern const unsigned int werewolffeet_run_down_image1[];
extern const unsigned int werewolffeet_run_down_image2[];

extern const unsigned short werewolfupperbody_run_down_pal[];
extern const unsigned int werewolfupperbody_run_down_image0[];
extern const unsigned int werewolfupperbody_run_down_image1[];

extern const unsigned short werewolfupperbody_run_side_pal[];
extern const unsigned int werewolfupperbody_run_side_image0[];
extern const unsigned int werewolfupperbody_run_side_image1[];
extern const unsigned int werewolfupperbody_run_side_image2[];

extern const unsigned short werewolftail_side_pal[];
extern const unsigned int werewolftail_side_image0[];

extern const unsigned short werewolffeet_run_side_pal[];
extern const unsigned int werewolffeet_run_side_image0[];
extern const unsigned int werewolffeet_run_side_image1[];
extern const unsigned int werewolffeet_run_side_image2[];
extern const unsigned int werewolffeet_run_side_image3[];
extern const unsigned int werewolffeet_run_side_image4[];
...
extern const unsigned int werewolffeet_run_up_image1[];
extern const unsigned int werewolffeet_run_up_image2[];
