...
extern const unsigned int skull_demon_arm_down_image4[];
extern const unsigned int skull_demon_arm_side_image0[];
extern const unsigned int skull_demon_arm_side_image1[];
extern const unsigned int skull_demon_arm_side_image2[];
