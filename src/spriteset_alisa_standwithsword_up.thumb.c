...
const SpriteLayer alisa_standwithsword_up_layerSet0[] = {
    {sword_side_set_image2,8,12,WIDE,SMALL_B,DO_HFLIP,NO_VFLIP,NO_COMPRESSION,0,1},
    {alisa_standwithsword_up_image0,0,0,TALL,MEDIUM,NO_HFLIP,NO_VFLIP,NO_COMPRESSION,4,0}};
