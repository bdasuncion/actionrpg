...
const SpriteLayer wickedknight_walk_down_layerSet0[] = {
    {wickedknight_sword_vertical_image0,-1,-27,TALL,SMALL_B,NO_HFLIP,NO_VFLIP,NO_COMPRESSION,0,0},
    {wickedknight_armsholdingsword_down_image0,0,1,WIDE,SMALL_A,NO_HFLIP,NO_VFLIP,NO_COMPRESSION,4,0},
