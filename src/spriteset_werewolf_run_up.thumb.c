...
const SpriteLayer werewolf_run_up_layerSet0[] = {
    ...
    {werewolfarm_up_image0,-4,4,TALL,SMALL_A,DO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,4,0},
    {werewolfarm_up_image0,12,4,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0}};
const SpriteLayer werewolf_run_up_layerSet1[] = {
    {werewolftail_up_image0,2,5,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,0,0},
    {werewolfupperbody_run_up_image0,0,3,SQUARE,SMALL_B,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
    {werewolfarm_up_image1,-4,4,TALL,SMALL_A,DO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,4,0},
    {werewolfarm_up_image2,12,4,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
...
const SpriteLayer werewolf_run_up_layerSet2[] = {
    {werewolftail_up_image0,2,5,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,0,0},
    {werewolfupperbody_run_up_image0,0,3,SQUARE,SMALL_B,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
    {werewolfarm_up_image2,12,4,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,4,0},
    {werewolfarm_up_image1,-4,4,TALL,SMALL_A,DO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
    {werewolfhead_up_image0,4,0,SQUARE,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
...
const SpriteLayer werewolf_run_up_layerSet5[] = {
    {werewolftail_up_image0,2,5,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,0,0},
    {werewolfupperbody_run_up_image0,0,3,SQUARE,SMALL_B,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
    {werewolfarm_up_image2,-4,4,TALL,SMALL_A,DO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,4,0},
    {werewolfarm_up_image1,12,4,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
    {werewolfhead_up_image0,4,0,SQUARE,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
...
const SpriteLayer werewolf_run_up_layerSet7[] = {
    {werewolftail_up_image0,2,5,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,0,0},
    {werewolfupperbody_run_up_image0,0,3,SQUARE,SMALL_B,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
    {werewolfarm_up_image1,12,4,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,4,0},
    {werewolfarm_up_image2,-4,4,TALL,SMALL_A,DO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
    {werewolfhead_up_image0,4,0,SQUARE,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
    {werewolffeet_run_up_image1,0,19,SQUARE,SMALL_B,DO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,1,0}};
