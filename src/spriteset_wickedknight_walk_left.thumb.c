...
const SpriteLayer wickedknight_walk_left_layerSet0[] = {
    {wickedknight_sword_vertical_image1,6,-24,TALL,SMALL_B,NO_HFLIP,NO_VFLIP,NO_COMPRESSION,0,0},
    {wickedknight_armsholdingsword_side_image0,-1,4,WIDE,SMALL_A,NO_HFLIP,NO_VFLIP,NO_COMPRESSION,4,0},
