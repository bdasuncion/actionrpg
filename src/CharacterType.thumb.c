...
const FuncCharacterInit character_InitFunctionsCollection[] = { &alisa_init, /*NULL, &ghostlyHand_init, &ghostMan_init, NULL,*/ &werewolf_init, /*&crow_init,*/ &zombie_init };
const FuncCharacterSet characterSet[] = { &alisa_setCharacter, /*NULL, &ghostlyHand_setCharacter, &ghostMan_setCharacter, NULL, */
