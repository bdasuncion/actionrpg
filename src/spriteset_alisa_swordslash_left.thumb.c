...
const SpriteLayer alisa_swordslash_left_layerSet0[] = {
    {sword_side_set_image0,8,10,WIDE,SMALL_B,DO_HFLIP,DO_VFLIP,NO_COMPRESSION,0,1},
...
const SpriteLayer alisa_swordslash_left_layerSet1[] = {
    {sword_vertical_set_image3,5,10,TALL,SMALL_B,NO_HFLIP,DO_VFLIP,NO_COMPRESSION,0,1},
...
const SpriteLayer alisa_swordslash_left_layerSet2[] = {
    {sword_vertical_set_image4,-1,12,TALL,SMALL_B,NO_HFLIP,DO_VFLIP,NO_COMPRESSION,0,1},
