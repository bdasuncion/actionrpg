...
const SpriteLayer werewolf_stand_down_layerSet0[] = {
    ...
    {werewolfarm_down_image0,12,5,TALL,SMALL_A,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,1,0},
    {werewolfarm_down_image0,-4,5,TALL,SMALL_A,DO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,2,0},
