...
const SpriteLayer alisa_swordslash_up_layerSet0[] = {
    ...
    {sword_vertical_image1,10,15,TALL,SMALL_B,NO_HFLIP,NO_VFLIP,LZSS_COMPRESSION,8,1}};
const SpriteLayer alisa_swordslash_up_layerSet1[] = {
    ...
    {sword_side_image0,12,7,WIDE,SMALL_B,DO_HFLIP,DO_VFLIP,LZSS_COMPRESSION,8,1}};
const SpriteLayer alisa_swordslash_up_layerSet2[] = {
    ...
    {sword_vertical_image1,2,-24,TALL,SMALL_B,DO_HFLIP,DO_VFLIP,LZSS_COMPRESSION,8,1}};
const SpriteLayer alisa_swordslash_up_layerSet3[] = {
    ...
    {sword_vertical_image1,-4,-25,TALL,SMALL_B,DO_HFLIP,DO_VFLIP,LZSS_COMPRESSION,8,1}};
