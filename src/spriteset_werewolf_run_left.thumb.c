...
const SpriteLayerSet werewolf_run_left_layerSet[] = {
    ...
    {werewolf_run_left_layerSet1,5,5},
    {werewolf_run_left_layerSet2,9,5},
    {werewolf_run_left_layerSet3,5,5},
    {werewolf_run_left_layerSet4,5,5},
    {werewolf_run_left_layerSet5,5,5},
    {werewolf_run_left_layerSet6,9,5},
    {werewolf_run_left_layerSet7,5,5},
};
